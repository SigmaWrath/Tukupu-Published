...
The Far Realms are infinite in number and are <span style="color:rgb(125, 125, 125)">(for the most part)</span> entirely inaccessible by all except for [[Deities]]. They encompass the subset of planes that are [[index|Tukupu]] without [[Ao]].  

The vast majority of the Far Realms have laws of physics completely different to that of the [[Inner Planes]], which would prevent creatures from traveling there as they wouldn't be able to exist. These kinds of realms are called [[Bizarre Realms]].
...
Realms that are considered "connected" occur because stable connection is facilitated by the [[The Lovers|Lovers]]. However, energy fluctuations can create transient connections through which entities from the Far Realms can "leak" into connected planes. This is where <span style="color:rgb(79, 151, 125)">**Aberrations**</span> come from. This transient connection goes both ways, which is why the Far Realms are specified to be *almost* entirely inaccessible—they are not accessible deliberately, but it is technically possible to reach them accidentally as a result of interdimensional transient breakdowns.