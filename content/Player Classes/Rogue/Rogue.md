...
tags:
  ...
  - class
---
> *<span style="color:rgb(125, 125, 125)">A dextrous expert in stealth and subterfuge.</span>*
...
| <span style="color:rgb(125, 125, 125)">Core Traits</span> | <span style="color:rgb(125, 125, 125)">Rogue</span>                                                                                           |
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Primary Ability**                                       | Dexterity                                                                                                                                     |
| **Hit Point Die**                                         | 1d8 per Rogue level                                                                                                                           |
| **Saving Throw Proficiencies**                            | Dexterity and Intelligence                                                                                                                    |
| **Skill Proficiencies**                                   | *Choose four*: Acrobatics, Athletics, Deception, Insight, Intimidation, Investigation, Perception, Persuasion, Sleight of Hand, or Stealth    |
...
#### <span style="color:rgb(203, 123, 55)">Becoming a Rogue</span>

##### <span style="color:rgb(134, 93, 187)">At Level 1</span>

- Gain all the traits in the Rogue Core Traits table
...
- Gain Rogue Hit Point Die, proficiency in one skill of your choice from the Rogue’s skill list, proficiency with Thieves’ Tools, and training with Light armor
- Gain the Rogue’s level 1 features listed in the Rogue Features table
#### <span style="color:rgb(203, 123, 55)">Rogue Class Features</span> 


| Level | Proficiency Bonus | Class Features                                                               | Sneak Attack |
| ----- | ----------------- | ---------------------------------------------------------------------------- | ------------ |
| 1     | +2                | [[Expertise]], [[Sneak Attack]], [[Thieves’ Cant]], [[Rogue Weapon Mastery]] | 1d6          |
| 2     | +2                | [[Cunning Action]]                                                           | 1d6          |
| 3     | +2                | Rogue Subclass                                                               | 2d6          |
| 4     | +2                | [[Ability Score Improvement]], [[Steady Aim]]                                | 2d6          |
