...
#### <span style="color:rgb(203, 123, 55)">Level 3: Experimental Elixirs</span>
...
**<span style="color:rgb(134, 93, 187)">Drinking an Elixir</span>**: As a Bonus Action, a creature can drink the elixir or administer it to another creature within 5 feet of itself. <span style="color:rgb(192, 82, 75)">An effect from the table cannot stack with itself.</span>

<span style="color:rgb(193, 145, 56)">When you reach certain Fighter levels, you can make an additional elixir at the end of each Long Rest: a total of three at level 7, four at level 10, five at level 15, and six at level 18.</span>

#### <span style="color:rgb(203, 123, 55)">Level 3: Ancillary Mobility Potions</span>
...
> ***<span style="color:rgb(134, 93, 187)">Fortify</span>***: When you expend a use of [[Second Wind]] to heal yourself, you supplement it with a sip of potion, healing for additional Hit Points equal to twice your Constitution Modifier.
> 
> ***<span style="color:rgb(134, 93, 187)">Restore</span>***: You can replicate the effect of the [[Lesser Restoration]] spell by using a Bonus Action to administer a potion to a creature you touch. You can do so a number of times equal to your Proficiency Bonus, regaining all expended uses on a Long Rest.

#### <span style="color:rgb(203, 123, 55)">Level 7: Alchemical Attunement</span>

You can choose the effect of half your <span style="color:rgb(203, 123, 55)">Experimental Elixirs</span> (rounded down) when you create them after a Long Rest.
#### <span style="color:rgb(203, 123, 55)">Level 10: Alchemist's Explosive</span>
...
#### <span style="color:rgb(203, 123, 55)">Level 18: Elixir Mastery</span>

You choose the effect of each of your <span style="color:rgb(203, 123, 55)">Experimental Elixirs</span> when you create them.

#### <span style="color:rgb(203, 123, 55)">Level 18: Explosive Strikes</span>

You have carefully engineered a molecular chain reaction, perfecting a viscous liquid that has an explosive effect when significant kinetic energy is added to it. When you deal damage with a weapon as part of your [[Action Surge]], your weapon or ammunition can be coated in this concoction to deal an extra 2d8 Force damage.