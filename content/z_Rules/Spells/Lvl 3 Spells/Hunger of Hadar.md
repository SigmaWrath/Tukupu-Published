...
You open a window observing one of the [[Far Realms]], the planes beyond, infested with unspeakable horrors. A 20-foot-radius Sphere of [[Darkness (Rules)|Darkness]] appears, centered on a point with range and lasting for the duration. The Sphere is Difficult Terrain, and it is filled with strange whispers and slurping noises, which can be heard up to 30 feet away. No light, magical or otherwise, can illuminate the area, and creatures fully within it have the [[Blinded]] condition. 
