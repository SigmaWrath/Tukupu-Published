...
|---|---|---|---|
|Action|Touch|V, S, M (a feather)|[[Concentration]], up to 10 minutes|
...
***<span style="color:rgb(134, 93, 187)">Using a Higher-Level Spell Slot</span>***: You can target one additional creature for each spell slot level above 3.